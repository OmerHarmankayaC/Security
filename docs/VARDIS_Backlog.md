...
| B-23 | Kapsama açığı ve fazla kadro kayıtlarının zaman damgasına taşınması. Kayıtlar bugün tarih ve ofsetsiz saat olarak tutuluyor; atama tablosu Tur 5'te zaman damgasına geçtiği hâlde bu iki tablo geride kaldı. Sonucu: dışa aktarmada gece yarısını aşan bir açık aralığı okunamıyor, çünkü saklanmayan bir ofset uydurmadan ISO damgası kurulamıyor. Aynı gerekçe her iki tablo için de geçerlidir (SRS 7.2). | Tur 10 — dışa aktarma işinden önce | Orta |
